...
public interface DAOController {
    ...
    void removeRole(Role role, String id) throws MemberNotExist, DontHavePermissionException;
    ...
    void addSeason(Role role, Season season) throws AlreadyExistException, DontHavePermissionException, ObjectNotExist;

    void addLeague(Role role, League league) throws AlreadyExistException, DontHavePermissionException, ObjectNotExist;
    ...
    void updateOwner(Role role,Owner owner)throws MemberNotExist, DontHavePermissionException, ObjectNotExist;
    void updateManager(Role role,Manager manager) throws MemberNotExist, DontHavePermissionException, ObjectNotExist;
    void updateReferee(Role role,Referee referee) throws MemberNotExist, DontHavePermissionException, ObjectNotExist;
    void updateGame(Role role,Game game) throws MemberNotExist, DontHavePermissionException, ObjectNotExist;
    void updateCoach(Role role,Coach coach) throws MemberNotExist, DontHavePermissionException, ObjectNotExist;
    void updateFan(Role role,Fan fan) throws MemberNotExist, DontHavePermissionException, ObjectNotExist;
    void updatePlayer(Role role,Player player) throws MemberNotExist, DontHavePermissionException, ObjectNotExist;
