...
public class InMemoryDB {
    ...
    */}
    ...
    public HashSet<Game> getGames(String strLeague, String season) throws ObjectNotExist {
        HashSet<Game> games = new HashSet<>();
        League league = leagues.get(strLeague);
        LeagueInSeason leagueInSeason = league.getLeagueInSeason(league.getSeason(season));
        return leagueInSeason.getGames();
    }
