...
//      dbController.removeSeason(this ,season.getYear());
    ...
    public void insertSchedulingPolicy(String id, String league, String season, String sPolicy) throws ObjectNotExist, DontHavePermissionException, MemberNotExist {
        if (!dbController.existAssociationDelegate(id)) {
            throw new MemberNotExist();
        }
        AssociationDelegate currAssociationDelegate = dbController.getAssociationDelegate(id);
    ...
    public void changeScorePolicy(String id, String league, String season, String sWinning, String sDraw, String sLosing) throws IncorrectInputException, ObjectNotExist {
        try {
            if (!dbController.existAssociationDelegate(id)) {
                throw new MemberNotExist();
            }
     ...
     */
    public ScorePolicy getScorePolicy(String id, String league, String season) throws DontHavePermissionException, ObjectNotExist, MemberNotExist {
        League leagueObj = dbController.getLeague(league);
        Season seasonObj = dbController.getSeason(season);
        LeagueInSeason leagueInSeason = leagueObj.getLeagueInSeason(seasonObj);
     ...
     */
    public void addRefereeToLeagueInSeason(String id, String league, String season, String refereeName) throws ObjectNotExist, ObjectAlreadyExist, DontHavePermissionException, MemberNotExist {
        if (!dbController.existAssociationDelegate(id)) {
            throw new MemberNotExist();
        }
        AssociationDelegate currAssociationDelegate = dbController.getAssociationDelegate(id);
