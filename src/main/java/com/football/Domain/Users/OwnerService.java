...
public class OwnerService {
    ...
    public void addTeam(String id, Team team) throws MemberNotExist, AlreadyExistException, DontHavePermissionException {
    ...
    public void removeTheTeamFromMyList(String id, String name) throws MemberNotExist, DontHavePermissionException, ObjectNotExist {
        if (dbController.existOwner(id)) {
            Owner currOwner = dbController.getOwner(id);
     ...
     */
    public void addManager(String id, String teamName, String mailId) throws MemberNotExist, AlreadyExistException, DontHavePermissionException {
        if (!dbController.existOwner(id)) {
            throw new MemberNotExist();
        }
        Owner currOwner = dbController.getOwner(id);
...
//            teams.replace(teamName, team);
     ...
     * @param teamName
     */
    public void addField(String id, String teamName, String fieldName) throws DontHavePermissionException, MemberNotExist {
        if (!dbController.existOwner(id)){
            throw new MemberNotExist();
        }
        Owner currOwner = dbController.getOwner(id);
...
//                teams.replace(teamName, team);
     ...
     * @param fieldName
     */
    public void removeField(String id, String teamName, String fieldName) throws DontHavePermissionException, MemberNotExist {
        if (!dbController.existOwner(id)){
            throw new MemberNotExist();
        }
        Owner currOwner = dbController.getOwner(id);
...
//                teams.replace(teamName, team);
     ...
     * @param mailId
     */
    public void addNewOwner(String id, String teamName, String mailId) throws MemberNotExist, AlreadyExistException, DontHavePermissionException {
        if (!dbController.existOwner(id)){
            throw new MemberNotExist();
        }
        Owner currOwner = dbController.getOwner(id);
...
//            teams.replace(teamName, team);
     ...
     * @param teamName
     */
    public void temporaryTeamClosing(String id, String teamName) throws DontHavePermissionException, MemberNotExist {
        if (!dbController.existOwner(id)){
            throw new MemberNotExist();
        }
        Owner currOwner = dbController.getOwner(id);
...
//        teams.replace(teamName, team);
     ...
     * @param teamName
     */
    public void reopenClosedTeam(String id, String teamName) throws DontHavePermissionException, MemberNotExist {
        if (!dbController.existOwner(id)){
            throw new MemberNotExist();
        }
        Owner currOwner = dbController.getOwner(id);
...
//        teams.replace(teamName, team);
     ...
     * @param amount
     */
    public void addOutCome(String id, String teamName, String description, double amount) throws NoEnoughMoney, DontHavePermissionException, MemberNotExist {
        if (!dbController.existOwner(id)){
            throw new MemberNotExist();
        }
        Owner currOwner = dbController.getOwner(id);
...
//        dbController.getTeams().replace(teamName, team);
     ...
     * @param amount
     */
    public void addInCome(String id, String teamName, String description, double amount) throws DontHavePermissionException, MemberNotExist {
        if (!dbController.existOwner(id)){
            throw new MemberNotExist();
        }
        Owner currOwner = dbController.getOwner(id);
...
//        dbController.getTeams().replace(teamName, team);
     ...
     */
    public void updatePlayerRole(String id, String teamName, String mailId,String role) throws DontHavePermissionException, MemberNotExist {
        if (!dbController.existOwner(id)){
            throw new MemberNotExist();
        }
        Owner currOwner = dbController.getOwner(id);
...
//                teams.replace(teamName, team);
     ...
     * @throws DontHavePermissionException
     */
    public void updateHomeField(String id, String teamName,String makeHomeField) throws DontHavePermissionException, MemberNotExist {
        if (!dbController.existOwner(id)){
            throw new MemberNotExist();
        }
        Owner currOwner = dbController.getOwner(id);
...
//        teams.replace(teamName, team);
    ...
    /****************************************** setters *********************************************/
    public void setMoneyToAccount(String id, String teamName, double amount) throws ObjectNotExist, MemberNotExist, DontHavePermissionException {
        if (!dbController.existOwner(id)){
            throw new MemberNotExist();
        }
        Owner currOwner = dbController.getOwner(id);
    ...
    public double getAccountBalance(String id, String teamName) throws ObjectNotExist, MemberNotExist {
        if (!dbController.existOwner(id)){
            throw new MemberNotExist();
        }
        Owner currOwner = dbController.getOwner(id);
