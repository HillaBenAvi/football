...
public class SystemManagerService {
    ...
    public boolean removeOwner(String id, String ownerId) throws IncorrectInputException, NotReadyToDelete, MemberNotExist, DontHavePermissionException {
        if (dbController.existSystemManager(id)) {
            SystemManager manager = dbController.getSystemManagers(id);
     ...
     * @throws AlreadyExistException- if a fan with this specific id already exist
     */
    public boolean removeSystemManager(String id, String idToRemove) throws MemberNotExist, IncorrectInputException, NotReadyToDelete, DontHavePermissionException, AlreadyExistException {
        if (dbController.existSystemManager(id)) {
            SystemManager manager = dbController.getSystemManagers(id);
     ...
     * @throws IncorrectInputException- if the id is not a mail
     */
    public boolean removeReferee(String id, String refereeId) throws DontHavePermissionException, MemberNotExist, AlreadyExistException, IncorrectInputException {
        if (dbController.existSystemManager(id)) {
            SystemManager manager = dbController.getSystemManagers(id);
     ...
     */
    public boolean removeMember(String id, String memberId) throws IncorrectInputException, DontHavePermissionException, MemberNotExist, AlreadyExistException, NotReadyToDelete {
        if (dbController.existSystemManager(id)) {
            SystemManager manager = dbController.getSystemManagers(id);
            if (isLegalid(id)) {
     ...
     */
    public boolean addReferee(String id, String refereeId, boolean ifMainReferee) throws IncorrectInputException, MemberAlreadyExistException, MemberNotExist, DontHavePermissionException, AlreadyExistException {
        if (dbController.existSystemManager(id)) {
            SystemManager manager = dbController.getSystemManagers(id);
            if (isLegalid(refereeId)) {
                if (!dbController.existReferee(refereeId)) {
     ...
     */
    public void addAssociationDelegate(String id, String associationDelegateId) throws DontHavePermissionException, MemberNotExist, AlreadyExistException {
        if (dbController.existSystemManager(id)) {
            SystemManager manager = dbController.getSystemManagers(id);
     ...
     */
    public void addOwner(String id, String ownerId) throws DontHavePermissionException, MemberNotExist, AlreadyExistException {
        if (dbController.existSystemManager(id)) {
            SystemManager manager = dbController.getSystemManagers(id);
     ...
     */
    public void addSystemManager(String id, String systemManagerId) throws MemberNotExist, DontHavePermissionException, AlreadyExistException {
        if (dbController.existSystemManager(id)) {
            SystemManager manager = dbController.getSystemManagers(id);
     ...
     */
    public boolean closeTeam(String id, String teamName) throws DontHavePermissionException, ObjectNotExist, MemberNotExist, AlreadyExistException, IncorrectInputException {
        if (dbController.existSystemManager(id)) {
            SystemManager manager = dbController.getSystemManagers(id);
     ...
     */
    public boolean addNewTeam(String id, String teamName, String idOwner) throws ObjectAlreadyExist, ObjectNotExist, MemberNotExist, DontHavePermissionException, AlreadyExistException, IncorrectInputException {
        if (dbController.existSystemManager(id)) {
            SystemManager manager = dbController.getSystemManagers(id);
     ...
     * @return
     */
    public LinkedList<String> watchComplaint(String id, String path) throws DontHavePermissionException, MemberNotExist {
        if (dbController.existSystemManager(id)) {
            SystemManager manager = dbController.getSystemManagers(id);
